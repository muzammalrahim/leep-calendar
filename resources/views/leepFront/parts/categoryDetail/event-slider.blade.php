...
<div class="">
   --}}
   <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel"data-interval="1900">
      <div class="carousel-inner">
         ...
         @foreach ($full_events as $events)
            @if ($events->picture_name !='')
            {{-- @dump($events->feature_picture) --}}
               <div class="carousel-item {{ ($i == 0)? 'active':'' }}">
                  <a href="{{ route('eventDetail' ,['id'=> $events->id ]) }}" class="pointer">
                     <img src="{{URL::asset('leep_calender/images/Headers/'.$events->picture_name)}}"
