                            ...
                            <div class=" col-md-12" style="padding-top: 5px;">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="{{ $name }}" class="form-control" placeholder="Enter {{ $label }}" value="{{ old($name) }}">
                                    </div>
                                    ...
                                    <div class="form-group">
			                            ...
			                            <select class="form-control" aria-label="Default select example" name="{{ $name }}">
			                                ...
			                                <option value="Publish" {{ "Publish" == old($name) ? 'selected' : ''}}>Publish</option>
			                                <option value="Unpublish" {{ "Unpublish" == old($name) ? 'selected' : ''}}>Unpublish</option>
			                            </select>
			                        </div>
