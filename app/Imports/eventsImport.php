...
class eventsImport implements ToModel
{
    ...
    */
    ...
    {   
            ...
            /*$name = $row[0];
            $eventUpdate = events::where('name', $name)->first();
            if ($eventUpdate) {
                $eventUpdate->manager = ( isset($row[55]) )? $row[55]:'';
                $eventUpdate->save();
            ...
            // else{
                ...
                $event->event_address1 = ( isset($row[52]) )? $row[52]:'';
                $event->manager = ( isset($row[55]) )? $row[55]:'';
